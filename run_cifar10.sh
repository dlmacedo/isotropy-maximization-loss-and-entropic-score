...
python main.py -ei="ood" -et "train_classify" -ec "data~cifar10+model~densenetbc100+loss~isomaxisometric_no_no_no_final" -gpu 0 -x 1
...
#python main.py -ei="ood" -et "train_classify" -ec "data~cifar10+model~resnet110+loss~isomaxisometric_no_no_no_final" -gpu 0 -x 5
...
#python detect.py --dir ood --dataset cifar10 --net_type densenetbc100 --loss isomaxisometric_no_no_no_final --gpu 0 -x 5
...
#python detect.py --dir ood --dataset cifar10 --net_type resnet110 --loss isomaxisometric_no_no_no_final --gpu 0 -x 5
