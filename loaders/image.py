...
class ImageLoader:
    ...
    def get_loaders(self):
        trainset_loader_for_train = DataLoader(
            self.trainset_for_train, batch_size=self.args.batch_size, suffle=True, num_workers=self.args.workers,
            worker_init_fn=self._worker_init)
        trainset_loader_for_infer = DataLoader(
            self.trainset_for_infer, batch_size=self.args.batch_size, suffle=False, num_workers=self.args.workers)
        valset_loader = DataLoader(
            self.val_set, batch_size=self.args.batch_size, suffle=False, num_workers=self.args.workers)
